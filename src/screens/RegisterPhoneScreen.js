...
import {FlagItem, Separator} from '../component';
...
const RegisterPhoneScreen = ({navigation}) =>{
  const [selectedCountry, setSelectedCountry] = useState(
    CountryCode.find(country => country.name === 'Ethiopia'),
  );
  ...
  const closeDropdown = (pageX, pageY) => {
    ...
    return(
        ...
        <StatusBar 
            ...
            />
            <Text style={styles.headerTitle}>Registration phone</Text>
            </View>
            <Text style={styles.title}>Registration Phone</Text>
